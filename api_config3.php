...
params::$params["api_config"] = array(
	...
	"api_url" => "https://api3.adsterratools.com/advertiser/e1ee46af6596c438413aaaafea953214/stats.json?start_date=#START_DATE#&finish_date=#END_DATE#&group_by[]=date",//Адрес API
	"auth_method" => "inurl token",//Метод авторизации
	"data_format" => "json",//Формат ответа
	"table_name" => "advertiser_json",//Название таблицы для данных
