...
params::$params["api_config"] = array(
	...
	"api_url" => "https://api3.adsterratools.com/advertiser/e1ee46af6596c438413aaaafea953214/stats.json?start_date=2018-02-15&finish_date=2018-02-16&group_by[]=date",//Àäğåñ API
	"auth_method" => "inurl token",//Ìåòîä àâòîğèçàöèè
	"data_format" => "json",//Ôîğìàò îòâåòà
