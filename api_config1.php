...
params::$params["api_config"] = array(
	...
	"api_url" => "http://login.revenueonsteroids.com/publisher/svc?action=outcsv&login=support%40cpmrevenue.com&password=axJFrN&channel=ZoneReports&dim=date&f.zone=46498&f.date=#START_DATE#_#END_DATE#&appType=CPM",//Адрес API
